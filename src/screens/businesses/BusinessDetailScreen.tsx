        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={styles.errorContainer}>
                    <Ionicons name="alert-circle-outline" size={48} color={neutral.gray400} />
        ...
        <View style={styles.container}>
            ...
            <View style={styles.heroContainer}>
                <View style={styles.heroImage}>
                    <Ionicons name={getTypeIcon(business.type)} size={64} color={brand.primary} />
                </View>
                <View style={styles.heroInfo}>
                    ...
                    <View style={styles.ratingRow}>
                        ...
                        <Text style={styles.reviewsText}>({business.totalReviews} reseñas)</Text>
                    </View>
                </View>
            </View>
                        ...
                        <View style={styles.section}>
                            ...
                            {business.address && (
                                <TouchableOpacity style={styles.contactRow} onPress={handleMaps}>
                                    ...
                                    <Ionicons name="open-outline" size={16} color={neutral.gray400} />
                                </TouchableOpacity>
                            )}
                            ...
                            {business.phone && (
                                <TouchableOpacity style={styles.contactRow} onPress={handleCall}>
                                    <View style={styles.contactIcon}>
                                        <Ionicons name="call-outline" size={20} color={brand.primary} />
                                    </View>
                    ...
                    <>
                        {products.length === 0 ? (
                            <View style={styles.emptyProducts}>
                                <Ionicons name="basket-outline" size={48} color={neutral.gray400} />
                                <Text style={styles.emptyProductsText}>No hay productos disponibles</Text>
                            </View>
                        ) : (
                                    ...
                                    {categoryProducts.map(product => (
                                        <View key={product.id} style={styles.productCard}>
                                            <View style={styles.productImage}>
                                                <Ionicons name="cube-outline" size={24} color={neutral.gray400} />
                                            </View>
            ...
            {business.phone && (
                <View style={[styles.bottomCta, { paddingBottom: insets.bottom + 16 }]}>
                    ...
                    <TouchableOpacity style={styles.ctaButtonSecondary} onPress={handleMaps}>
